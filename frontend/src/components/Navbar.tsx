  ...
  return (
    <div className="flex items-center justify-between py-5 font-medium">
        ...
        <div className="flex items-center gap-6">
            <img src={assets.search_icon} onClick={()=>context?.setShowsearch(true)} alt="" className="w-5 cursor-pointer" />
            ...
            <Link to="/cart" className="relative">
                ...
                <p className="absolute right-[-5px] bottom-[-5px] w-4 text-center leading-4 bg-black text-white
                    aspect-square rounded-full text-[8px]">{context?.getcartcount()}</p>
            </Link>
